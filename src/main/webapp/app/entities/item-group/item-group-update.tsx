...
export class ItemGroupUpdate extends React.Component<IItemGroupUpdateProps, IItemGroupUpdateState> {
  ...
  render() {
    const { itemGroupEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="onlineFabricApp.itemGroup.home.createOrEditLabel">Create or edit a ItemGroup</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : itemGroupEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="item-group-description">
                    Description
                  </Label>
                  <AvField
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  updateSuccess: storeState.itemGroup.updateSuccess
});
